...
\begin{center}
  \includegraphics[height=8cm]{1b1}
  \includegraphics[height=8cm]{1b2}
...
\begin{center}
  \includegraphics[height=8cm]{1c1}
  \includegraphics[height=8cm]{1c3}
...
\begin{center}
  \includegraphics[height=8cm]{1di}
  \includegraphics[height=8cm]{1dii}
...
Here, let us consider the contents of $u$ within nour neighborhood. We can change the size of our neighborhood, as long as the size does not exceed $\Omega$'s boundaries, and move the center of our neighborhood throughout the region.

\begin{center}
  \includegraphics[height=6cm]{1ei}
  \includegraphics[height=6cm]{1eii}\\
  \includegraphics[height=6cm]{1fi}
  \includegraphics[height=6cm]{1fii}\\
\end{center}
...
\begin{center}
  \includegraphics[height=6cm]{1fi}
  \includegraphics[height=6cm]{1fii1}\\
  \includegraphics[height=6cm]{1gi}
  \includegraphics[height=6cm]{1gii}\\
\end{center}
